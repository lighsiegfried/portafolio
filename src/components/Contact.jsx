...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        ...
        {
          from_name: form.name,
          to_name: "Desarrollador de software",
      ...
      .then(
        ...
        (error) => {
          ...
          alert("Al parecer algo salio mal, por favor reintentar.");
        }
      );
  };
  ...
  return (
    ...
    >
      ...
      >
        <p className={styles.sectionSubText}>Ponerse en</p>
